...
class GetDataset:
    def __init__(self,datadir,rawdir,df,pdb_id_column):
        self.datadir = datadir              #  data directory to our workspace
        self.rawdir = rawdir                #  directory to our raw data (specific for chosen dataset), if you are gonna use your own, type None, and skip convert step
        self.df = df                        #  path to the dataframe with yours complexes
